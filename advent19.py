...
#shuffle(replace)
# A good order:
replace = [('P', 'PTi'), ('P', 'SiRnFAr'), ('H', 'CRnFYMgAr'), ('Ca', 'PB'), ('O', 'NRnFAr'), ('Th', 'ThCa'), ('Si', 'CaSi'), ('Ca', 'CaCa'), ('O', 'OTi'), ('N', 'HSi'), ('H', 'HCa'), ('H', 'ORnFAr'), ('Ca', 'SiRnMgAr'), ('F', 'PMg'), ('F', 'SiAl'), ('H', 'CRnAlAr'), ('O', 'CRnFYFAr'), ('Ti', 'BP'), ('O', 'HP'), ('H', 'NRnMgAr'), ('B', 'BCa'), ('F', 'CaF'), ('H', 'CRnFYFYFAr'), ('e', 'OMg'), ('Al', 'ThF'), ('e', 'HF'), ('e', 'NAl'), ('N', 'CRnFAr'), ('Mg', 'TiMg'), ('B', 'TiRnFAr'), ('H', 'NRnFYFAr'), ('Ca', 'PRnFAr'), ('Ti', 'TiTi'), ('H', 'CRnMgYFAr'), ('Ca', 'SiTh'), ('P', 'CaP'), ('H', 'OB'), ('O', 'CRnMgAr'), ('H', 'NTh'), ('Al', 'ThRnFAr'), ('B', 'TiB'), ('Mg', 'BF'), ('Ca', 'SiRnFYFAr')]
#print(replace)
